...
const Sidebar = ({ sidebarToggle, onMenuItemClick }) => {
  return (
   ...
   <Link className=' hover: flex items-center text-center justify-center uppercase h-[50px] before:ease relative   overflow-hidden border border-green-500 bg-green-500 text-white shadow-2xl transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:shadow-green-500 hover:before:-translate-x-40' to="/admin/logo">Logo</Link>
   <Link className=' hover: flex items-center text-center justify-center uppercase h-[50px] before:ease relative   overflow-hidden border border-green-500 bg-green-500 text-white shadow-2xl transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:shadow-green-500 hover:before:-translate-x-40' to="/admin/comments">Comment</Link>
   <Link className=' hover: flex items-center text-center justify-center uppercase h-[50px] before:ease relative   overflow-hidden border border-green-500 bg-green-500 text-white shadow-2xl transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:shadow-green-500 hover:before:-translate-x-40' to="/admin/category">Category</Link>
   <Link className=' hover: flex items-center text-center justify-center uppercase h-[50px] before:ease relative   overflow-hidden border border-green-500 bg-green-500 text-white shadow-2xl transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:shadow-green-500 hover:before:-translate-x-40' to="/admin/subscribtion">Subscribtion</Link>
   </div>
    </div>
  );
};
